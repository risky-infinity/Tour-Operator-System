...
<div id="portfolio" class="portfolio">
   <div class="top-tours-head text-center">
	      ...
	      <ul id="filters" class="clearfix wow bounceIn" data-wow-delay="0.4s">
			...
			<li><span class="filter" data-filter="card"></span></li>
			<li><span class="filter" data-filter="icon"></span></li>
			<li><span class="filter" data-filter="fun"></span></li> -->
	        </ul>
		  ...
		  <div class="contact-grids">
			  <div class="container">
				  <div class="col-md-4 address">
						<h4 style="color:#09F">VSVR Enterprises</h4>
						...
						<h5 style="color:#000"><span class="img2"></span><a href="#">info@vsvrtour.com&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;support@vsvrtour.com</a></h5>
						<h5 style="color:#000"><span class="img3"></span>Terna Colony, Nerul, Navi Mumbai</h5>
                        <br/>
