...
$thanks = ' for your enquiry, we will arrange your booking and get back to you shortly!' ;
$message  = 'Thank you ' . $_POST['t1'] . $thanks;
$headers  = 'From: VSVR@gmail.com' . "\r\n" .
            'MIME-Version: 1.0' . "\r\n" .
...
<tr><td style="font-size:24px; color:#09F; font-family: 'Raleway', sans-serif;">To go back</td></tr>
<?php
...
<tr><td class="headingText" style="font-family: 'Raleway', sans-serif;">Enquiry</td></tr>
...
<form method="post" enctype="multipart/form-data" style="font-family: 'Raleway', sans-serif;">
